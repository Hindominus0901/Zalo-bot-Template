...
Đọc `/HUONG-DAN-AGENT.md` (từ gốc repo) và làm đúng thứ tự B0→B7. Phỏng vấn
`PHONG-VAN.md`. Wiki theo `knowledge/wiki/TRANG-MAU.md` — đừng tạo trang trống.
Xong QR thì chạy `docs/04-kich-ban-thu.md` (30 dòng) và `python3 -m unittest discover -s tests -v`.
